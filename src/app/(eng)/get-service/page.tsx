...
export const metadata: Metadata = SEO({
    title: 'Inspectex | طلب الخدمة',
    description: 'طلب الخدمة',
    keywords: 'InspectEx, طلب الخدمة, InspectEx, طلب الخدمة, InspectEx, طلب الخدمة, InspectEx, طلب الخدمة',
    openGraph: {
        url: 'https://inspectex.sa/get-service',
        images: [
            {
